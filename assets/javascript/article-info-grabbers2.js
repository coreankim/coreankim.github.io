		...
		if (x === "AuthorList") {
			...
			if (multipleAuthors === true) {
				...
				if (Object.getOwnPropertyNames(articleObj.Article.AuthorList.Author[authorListLength-1]).join(",").includes("CollectiveName") === true) {
					authors.lastAuthorFirstName = articleObj.Article.AuthorList.Author[authorListLength-2].ForeName;
				} else {
				...
				for (var j=0; j<authorListLength; j++) {
					if (Object.getOwnPropertyNames(articleObj.Article.AuthorList.Author[j]).includes("CollectiveName") === true) {
				...
				console.log(articleObj.Article.AuthorList.Author)
				if (authors.lastAuthorFirstName.includes(" ")) {
